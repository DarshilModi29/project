      ...
      <div className="container-fluid products-2">
        <div className="row justify-content-md-center">
          <div className="col-md-10 col-sm-12">
            <div className="row">
              <div className="col-md-8 mb-3 col-sm-12">
              ...
              <div className="col-xl-12 col-md-10 col-sm-12">
                <p>
                  ...
                  <br /><br />
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet, tenetur veritatis. Incidunt, eius! Inventore ut iusto odit libero! Asperiores, dicta!
                </p>
              </div>
            </div>
          </div>
